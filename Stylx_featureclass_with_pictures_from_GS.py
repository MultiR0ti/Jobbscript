...
def main():
    ...
    symbology_lyr = r'\\nsv2-nasuni-02\GIS\03_FO\Geo\01_Felles\LYRS\borepoints\ImportExcelFromGeosuite1.lyrx'
    ...
    arcpy.management.MatchLayerSymbologyToAStyle(fc_out, "metode", stylx)
